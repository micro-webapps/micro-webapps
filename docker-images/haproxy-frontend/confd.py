...
def generate_config(kube_host, kube_port, key_file, cert_file, kube_namespace):
    ...
    os.system("rm -f /usr/local/etc/haproxy/*.json")
    os.system("rm -f /usr/local/etc/haproxy/*.cfg")
    envcmd = ""
    ...
    print (envcmd + " /haproxy-cfg /usr/local/etc/haproxy/ /usr/local/etc/haproxy/haproxy.cfg")
    os.system(envcmd + " /haproxy-cfg /usr/local/etc/haproxy/ /usr/local/etc/haproxy/haproxy.cfg")
